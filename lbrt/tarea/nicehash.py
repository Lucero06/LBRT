...
class private_api:
    ...
    def create_hashpower_order(self, market, type, algorithm, price, limit, amount, pool_id, algo_response):
        ...
        order_data = {
            ...
            "marketFactor": float(algo_setting['marketFactor']),
            "displayPriceFactor":algo_setting['displayPriceFactor'],
            "priceFactor":float(algo_setting['priceFactor']),
            "price": price,
            "poolId": pool_id,
            "limit": limit,
            "type": type
...
class wss_api:
    def __init__(self, market, host, organisation_id, key, secret, verbose=False):
        self.market=market
        self.host=host
        self.organisation_id=organisation_id
        self.key=key
